...
class Metro:
    def __init__(self):
        ...
        # es trasbordo esta en C: bellecour = Station("Bellecour", 45.7578272339404, 4.8336873209952, [1] )
        cordeliers = Station("Cordeliers", 45.7632413263491, 4.83574324907402, [1] )
        # es trasbordo esta en D: hotel_de_ville_louis_pradel = Station("Hôtel de Ville–Louis Pradel", 45.7673874887601, 4.83628164077502, [1] )
        ...
        #Linea B
        # es trasbordo esta en A: charpennes_charles_hernu = Station("Charpennes – Charles Hernu", 45.7705626837206, 4.8630017998644, [2] )
        ...
        # es trasbordo esta en B: saxe_gambetta = Station("Saxe-Gambetta", 45.7539, 4.847, [4] )
